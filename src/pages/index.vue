              ...
              <div class="children">
                <ul v-for="(item, i) in menuList" :key="i">
                  <li v-for="(sub, j) in item" :key="j">
                    <a :href="sub ? '/#/product/' + sub.id : ''"><img :src="sub ? sub.img : '../../static/imgs/item-box-1.png'" >{{sub ? sub.name : '小米9'}}</a>
                  </li>
                </ul>
              </div>
            </li>
        ...
        <div class="container">
          ...
          <div class="wrapper">
            <div class="banner-left">
              <a href="/#/product/35"><img src="../../static/imgs/mix-alpha.jpg" alt=""></a>
            </div>
            <div class="list-box">
              <div class="list" v-for="(arr, i) in phoneList" :key="i">
                <div class="item" v-for="(item, j) in arr" :key="j">
                  ...
                  <div class="item-info">
                    <h3>{{item.name}}</h3>
                    <p>{{item.subtitle}}</p>
                    <p class="price" @click="cart(item.id)">{{item.price | currency}}</p>
                  </div>
                </div>
              </div>
            </div>
